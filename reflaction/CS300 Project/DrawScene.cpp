...
int DrawScene::Init()
{
	...
	else if (meshType == DrawScene::mesh::skybox)
	{
		objReader->OBJReader::ReadOBJFile("../Common/models/cube.obj", &myMesh, OBJReader::ReadMethod::LINE_BY_LINE, false);
		myMesh = *(objReader->getMesh());
	}
...
int DrawScene::Render()
{
	...
	if (meshType != DrawScene::mesh::lamp && meshType != DrawScene::mesh::skybox)
	{
		glBindVertexArray(VertexArrayID);
	}
	else if(meshType == DrawScene::mesh::lamp)
	{
...
{
	if (meshType != DrawScene::mesh::lamp && meshType != DrawScene::mesh::Obj && meshType != DrawScene::mesh::skybox)
	{
